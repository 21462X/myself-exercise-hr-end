package com.spring.niit.vhr.config;
...
public class SwaggerConfig {
    ...
    // 接口作者联系方式
    private final Contact contact = new Contact("21462X","https://github.com/21462X","2274457767@qq.com");
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.spring.niit.vhr.controller"))
                .build();
    }
    /**
